...
urlpatterns = [
    path("csrf/", api_views.csrf_token, name="csrf-token"),
    ...
    path("dashboard/", dashboard_api.dashboard, name="dashboard"),

    path("clients/", include("clients.api_urls")),
    path("cases/", include("cases.api_urls")),
    path("hearings/", include("hearings.api_urls")),
